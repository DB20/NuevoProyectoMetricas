...

{
	...
	public ILista<ILista<NodoTS<K,V>>> listaNodos;
	public int tamanoAct;
	public int tamanoTabla;
	public double minicial;
	public double cantidadRehash;
	
	public TablaHashSeparteChaining(int tamInicial)
	{
		int m = HashMethods.nextPrime(tamInicial);
		minicial=m;
